...
Subunits.highCapDimerNum = 10;

allPFLocationBefore = zeros(size(allPFsBefore));
GTPchoice = 4;

[allPFsAfter,allPFLocationAfter,Subunits] = nucleationCapHigh(allPFsBefore,allPFLocationBefore,Subunits, GTPchoice);
...
assert(Subunits.highCapDimerNum == 9)
