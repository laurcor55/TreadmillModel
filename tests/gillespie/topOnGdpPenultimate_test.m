function h = topOnGdpPenultimate_test
  ...
  for repeat = 1:100
    ...
    allPFsBefore = {[1], [2; 3; 1; 2], [2], [1; 1; 5], [0],[],[2; 2; 2; 4; 2; 2],[1; 4; 5], [2; 3]};
    ...
    [allPFsAfter, Subunits] = topOnGdpPenultimate(allPFsBefore, Subunits, GTPchoice);
